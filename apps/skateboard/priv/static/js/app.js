...
var _blake_education$lettersmash$Actions$SubmitSuccess = function (a) {
...
var _blake_education$lettersmash$Views$hideClear = function (candidate) {
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(candidate),
		0);
};
var _blake_education$lettersmash$Views$hideGameover = function (boardState) {
	return _elm_lang$core$Basics$not(boardState.game_over);
};
var _blake_education$lettersmash$Views$hideSubmit = function (candidate) {
	return _elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(candidate),
		4) < 0;
};
			...
			case 'Backspace':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							candidate: _elm_lang$core$List$reverse(
								A2(
									_elm_lang$core$List$drop,
									1,
									_elm_lang$core$List$reverse(model.candidate))),
							errorMessage: ''
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		...
		A2(
			...
			_elm_lang$core$Json_Decode$list(
				_elm_lang$core$Json_Decode$list(
					A2(
						_elm_lang$core$Json_Decode$andThen,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'letter', _elm_lang$core$Json_Decode$string),
						function (letter) {
							return A2(
								_elm_lang$core$Json_Decode$andThen,
								...
								function (id) {
									return A2(
										_elm_lang$core$Json_Decode$andThen,
										A2(_elm_lang$core$Json_Decode_ops[':='], 'owner', _elm_lang$core$Json_Decode$int),
										function (owner) {
											return A2(
												_elm_lang$core$Json_Decode$andThen,
												A2(_elm_lang$core$Json_Decode_ops[':='], 'surrounded', _elm_lang$core$Json_Decode$bool),
												function (surrounded) {
													return _elm_lang$core$Json_Decode$succeed(
														{letter: letter, id: id, owner: owner, surrounded: surrounded});
												});
										});
								});
						})))),
							...
							_elm_lang$core$Json_Decode$list(
								A2(
									...
									function (word) {
										return A2(
											_elm_lang$core$Json_Decode$andThen,
											A2(_elm_lang$core$Json_Decode_ops[':='], 'played_by', _elm_lang$core$Json_Decode$int),
											function (played_by) {
												return _elm_lang$core$Json_Decode$succeed(
													{word: word, played_by: played_by});
											});
									}))),
						function (wordlist) {
							return A2(
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['GameBoard'], 'GameBoard', typeof _blake_education$lettersmash$GameBoard$main === 'undefined' ? null : _blake_education$lettersmash$GameBoard$main);
...
var _blake_education$lettersmash$GameLobby$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'UpdateLobby') {
			return {ctor: '_Tuple2', _0: _p0._0, _1: _elm_lang$core$Platform_Cmd$none};
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _blake_education$lettersmash$GameLobby$listGame = function (game) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(
				A2(_elm_lang$core$Basics_ops['++'], 'Game Name: ', game.name))
			]));
};
var _blake_education$lettersmash$GameLobby$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, _blake_education$lettersmash$GameLobby$listGame, model));
};
var _blake_education$lettersmash$GameLobby$initialModel = _elm_lang$core$Native_List.fromArray(
	[]);
var _blake_education$lettersmash$GameLobby$init = {ctor: '_Tuple2', _0: _blake_education$lettersmash$GameLobby$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _blake_education$lettersmash$GameLobby$gameList = _elm_lang$core$Native_Platform.incomingPort(
	'gameList',
	_elm_lang$core$Json_Decode$list(
		A2(
			_elm_lang$core$Json_Decode$andThen,
...
var _blake_education$lettersmash$GameLobby$Game = function (a) {
	return {name: a};
};
var _blake_education$lettersmash$GameLobby$UpdateLobby = function (a) {
	return {ctor: 'UpdateLobby', _0: a};
};
var _blake_education$lettersmash$GameLobby$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_blake_education$lettersmash$GameLobby$gameList(_blake_education$lettersmash$GameLobby$UpdateLobby)
			]));
};
var _blake_education$lettersmash$GameLobby$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _blake_education$lettersmash$GameLobby$init, update: _blake_education$lettersmash$GameLobby$update, view: _blake_education$lettersmash$GameLobby$view, subscriptions: _blake_education$lettersmash$GameLobby$subscriptions})
};
var _blake_education$lettersmash$GameLobby$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['GameLobby'] = Elm['GameLobby'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['GameLobby'], 'GameLobby', typeof _blake_education$lettersmash$GameLobby$main === 'undefined' ? null : _blake_education$lettersmash$GameLobby$main);
...
;require.register("web/elm/GameLobby", function(exports, require, module) {
...
;require.register("web/elm/elm-stuff/packages/elm-lang/html/1.0.0/src/Html/App", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/html/1.0.0/src/Html/Attributes", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/html/1.0.0/src/Html/Events", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/html/1.0.0/src/Html/Lazy", function(exports, require, module) {
...
// Lobby app
var elmDivLobby = document.getElementById('elm-lobby');
if (elmDivLobby) {
  (function () {
    ...
    var elmLobbyApp = Elm.GameLobby.embed(elmDivLobby);
    ...
    channel.on("game_list", function (gameList) {
    ...
    var button = document.getElementById("create_game");
