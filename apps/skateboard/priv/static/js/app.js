...
Elm.Models.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var initialModel = {candidate: _U.list([])
                      ,boardState: {board: _U.list([]),players: _U.list([]),wordlist: _U.list([]),game_over: false}
...
Elm.Actions.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var RequestNewGame = {ctor: "RequestNewGame"};
   var SubmitFailed = function (a) {    return {ctor: "SubmitFailed",_0: a};};
   var SubmitSuccess = function (a) {    return {ctor: "SubmitSuccess",_0: a};};
   var GameOver = function (a) {    return {ctor: "GameOver",_0: a};};
   var UpdateBoard = function (a) {    return {ctor: "UpdateBoard",_0: a};};
...
Elm.LocalEffects = Elm.LocalEffects || {};
Elm.LocalEffects.make = function (_elm) {
   "use strict";
   _elm.LocalEffects = _elm.LocalEffects || {};
   if (_elm.LocalEffects.values) return _elm.LocalEffects.values;
   var _U = Elm.Native.Utils.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var newGameMailbox = $Signal.mailbox("");
   var sendNewGame = function (message) {
      return A2($Effects.map,$Basics.always($Actions.NoOp),$Effects.task(A2($Signal.send,newGameMailbox.address,message)));
   };
   var submitMailbox = $Signal.mailbox(_U.list([]));
   var sendSubmit = function (letters) {
      return A2($Effects.map,$Basics.always($Actions.NoOp),$Effects.task(A2($Signal.send,submitMailbox.address,letters)));
   };
   return _elm.LocalEffects.values = {_op: _op,submitMailbox: submitMailbox,sendSubmit: sendSubmit,newGameMailbox: newGameMailbox,sendNewGame: sendNewGame};
};
Elm.Views = Elm.Views || {};
Elm.Views.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var letterClass = function (letter) {    return letter.surrounded ? "letter surrounded" : "letter";};
   var flash = F2(function (address,model) {
      return $String.isEmpty(model.errorMessage) ? A2($Html.span,_U.list([]),_U.list([])) : A2($Html.div,
   ...
   var letterView = F2(function (address,letter) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class(letterClass(letter)),letterStyle(letter),A2($Html$Events.onClick,address,$Actions.Select(letter))]),
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2(flash,address,model)
                      ,A2($Html.div,_U.list([$Html$Attributes.$class("board col-md-12")]),A2($List.map,boardRow(address),model.boardState.board))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("row")]),
              _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-default")
                              ,$Html$Attributes.disabled(hideClear(model.candidate))
                              ,A2($Html$Events.onClick,address,$Actions.Clear)]),
                      _U.list([$Html.text("Clear")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-default")
                              ,$Html$Attributes.disabled(hideClear(model.candidate))
                              ,A2($Html$Events.onClick,address,$Actions.Backspace)]),
                      _U.list([$Html.text("<-")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-primary")
                              ,$Html$Attributes.disabled(hideSubmit(model.candidate))
                              ,A2($Html$Events.onClick,address,$Actions.Submit)]),
                      _U.list([$Html.text("Submit")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn")
                              ,$Html$Attributes.disabled($Basics.not(model.boardState.game_over))
                              ,A2($Html$Events.onClick,address,$Actions.RequestNewGame)]),
                      _U.list([$Html.text("New Game")]))]))]))]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("row")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("board col-md-12")]),
              _U.list([A2($Html.h2,
              _U.list([$Html$Attributes.$class("candidate")]),
              _U.list([$Html.text(A3($List.foldl,F2(function (c,a) {    return A2($Basics._op["++"],a,c.letter);}),"",model.candidate))]))]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("row")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("col-md-4")]),A2($List.map,playerView,model.boardState.players))
                      ,A2($Html.div,_U.list([$Html$Attributes.$class("col-md-8")]),A2($List.map,wordlistView,model.boardState.wordlist))]))]));
   });
...
Elm.Update.make = function (_elm) {
   ...
   $Effects = Elm.Effects.make(_elm),
   $List = Elm.List.make(_elm),
   $LocalEffects = Elm.LocalEffects.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Models = Elm.Models.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var appendLetter = F2(function (letter,candidate) {
      return A2($List.member,letter,candidate) ? candidate : $List.reverse(A2($List._op["::"],letter,$List.reverse(candidate)));
   });
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Submit": return {ctor: "_Tuple2",_0: model,_1: $LocalEffects.sendSubmit(model.candidate)};
         case "RequestNewGame": return {ctor: "_Tuple2",_0: model,_1: $LocalEffects.sendNewGame("")};
         case "Select": return {ctor: "_Tuple2",_0: _U.update(model,{candidate: A2(appendLetter,_p0._0,model.candidate)}),_1: $Effects.none};
         case "Clear": return {ctor: "_Tuple2",_0: _U.update(model,{candidate: _U.list([]),errorMessage: ""}),_1: $Effects.none};
         case "Backspace": return {ctor: "_Tuple2"
                                  ,_0: _U.update(model,{candidate: $List.reverse(A2($List.drop,1,$List.reverse(model.candidate))),errorMessage: ""})
                                  ,_1: $Effects.none};
...
Elm.GameBoard.make = function (_elm) {
   ...
   var _op = {};
   var submitFailed = Elm.Native.Port.make(_elm).inboundSignal("submitFailed",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",v);
   });
   var submitSuccess = Elm.Native.Port.make(_elm).inboundSignal("submitSuccess",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",v);
   });
   var gameOver = Elm.Native.Port.make(_elm).inboundSignal("gameOver",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",v);
   });
   var boardState = Elm.Native.Port.make(_elm).inboundSignal("boardState",
   "Models.BoardState",
   function (v) {
      return typeof v === "object" && "board" in v && "players" in v && "wordlist" in v && "game_over" in v ? {_: {}
                                                                                                              ,board: typeof v.board === "object" && v.board instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.board.map(function (v) {
                                                                                                                 return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
                                                                                                                    return typeof v === "object" && "letter" in v && "id" in v && "owner" in v && "surrounded" in v ? {_: {}
                                                                                                                                                                                                                      ,letter: typeof v.letter === "string" || typeof v.letter === "object" && v.letter instanceof String ? v.letter : _U.badPort("a string",
                                                                                                                                                                                                                      v.letter)
                                                                                                                                                                                                                      ,id: typeof v.id === "number" && isFinite(v.id) && Math.floor(v.id) === v.id ? v.id : _U.badPort("an integer",
                                                                                                                                                                                                                      v.id)
                                                                                                                                                                                                                      ,owner: typeof v.owner === "number" && isFinite(v.owner) && Math.floor(v.owner) === v.owner ? v.owner : _U.badPort("an integer",
                                                                                                                                                                                                                      v.owner)
                                                                                                                                                                                                                      ,surrounded: typeof v.surrounded === "boolean" ? v.surrounded : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                      v.surrounded)} : _U.badPort("an object with fields `letter`, `id`, `owner`, `surrounded`",
                                                                                                                    v);
                                                                                                              ...
                                                                                                              v.game_over)} : _U.badPort("an object with fields `board`, `players`, `wordlist`, `game_over`",
      v);
   });
   var incomingActions = $Signal.mergeMany(_U.list([A2($Signal.map,$Actions.UpdateBoard,boardState)
                                                   ,A2($Signal.map,$Actions.GameOver,gameOver)
                                                   ,A2($Signal.map,$Actions.SubmitSuccess,submitSuccess)
                                                   ,A2($Signal.map,$Actions.SubmitFailed,submitFailed)]));
   var requestNewGame = Elm.Native.Port.make(_elm).outboundSignal("requestNewGame",function (v) {    return v;},$LocalEffects.newGameMailbox.signal);
   var submit = Elm.Native.Port.make(_elm).outboundSignal("submit",
   function (v) {
      return Elm.Native.List.make(_elm).toArray(v).map(function (v) {    return {letter: v.letter,id: v.id,owner: v.owner,surrounded: v.surrounded};});
   },
   $LocalEffects.submitMailbox.signal);
   var init = {ctor: "_Tuple2",_0: $Models.initialModel,_1: $Effects.none};
   var app = $StartApp.start({init: init,update: $Update.update,view: $Views.view,inputs: _U.list([incomingActions])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   return _elm.GameBoard.values = {_op: _op,app: app,main: main,init: init,incomingActions: incomingActions};
};

require.register("web/elm/Actions", function(exports, require, module) {

});

;require.register("web/elm/GameBoard", function(exports, require, module) {

});

;require.register("web/elm/LocalEffects", function(exports, require, module) {

});

;require.register("web/elm/Models", function(exports, require, module) {

});

;require.register("web/elm/Update", function(exports, require, module) {
...
;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Array", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Basics", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Bitwise", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Char", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Color", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Date", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Debug", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Dict", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Graphics/Collage", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Graphics/Element", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Graphics/Input", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Graphics/Input/Field", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Json/Decode", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Json/Encode", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Keyboard", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/List", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Maybe", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Mouse", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Array", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Basics", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Bitwise", function(exports, require, module) {
"use strict";
...
Elm.Native.Bitwise.make = function (localRuntime) {
	...
	function sll(a, offset) {
		return a << offset;
	}
	function sra(a, offset) {
		return a >> offset;
	}
	function srl(a, offset) {
		return a >>> offset;
	}
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Char", function(exports, require, module) {
"use strict";
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Color", function(exports, require, module) {
'use strict';
...
Elm.Native.Color.make = function (localRuntime) {
	...
	function toCss(c) {
		...
		if (c.ctor === 'RGBA') {
			...
			format = 'hsl';
			colors = c._0 * 180 / Math.PI + ', ' + c._1 * 100 + '%, ' + c._2 * 100 + '%';
		}
		if (c._3 === 1) {
			return format + '(' + colors + ')';
		} else {
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Date", function(exports, require, module) {
'use strict';
...
Elm.Native.Date.make = function (localRuntime) {
	...
	function readDate(str) {
		...
		return isNaN(date.getTime()) ? Result.Err('unable to parse \'' + str + '\' as a date') : Result.Ok(date);
	}
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Debug", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Graphics/Collage", function(exports, require, module) {
'use strict';
...
Elm.Native.Graphics.Collage.make = function (localRuntime) {
	...
	function toFont(props) {
		return [props['font-style'], props['font-variant'], props['font-weight'], props['font-size'], props['font-family']].join(' ');
	}
	...
	function makeTransform(w, h, form, matrices) {
		var props = form.form._0._0.props;
		var m = A6(Transform.matrix, 1, 0, 0, -1, (w - props.width) / 2, (h - props.height) / 2);
		var len = matrices.length;
		for (var i = 0; i < len; ++i) {
			m = A2(Transform.multiply, m, matrices[i]);
		}
		...
		return 'matrix(' + str(m[0]) + ', ' + str(m[3]) + ', ' + str(-m[1]) + ', ' + str(-m[4]) + ', ' + str(m[2]) + ', ' + str(m[5]) + ')';
	}
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Graphics/Element", function(exports, require, module) {
'use strict';
...
Elm.Native.Graphics.Element.make = function (localRuntime) {
	...
	var createNode = typeof document === 'undefined' ? function (_) {
		return {
			style: {},
	...
	var htmlHeight = typeof document !== 'undefined' ? realHtmlHeight : function (a, b) {
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Graphics/Input", function(exports, require, module) {
'use strict';
...
Elm.Native.Graphics.Input.make = function (localRuntime) {
	...
	function customButton(message, up, hover, down) {
		return A3(Element.newElement, max3(up._0.props.width, hover._0.props.width, down._0.props.width), max3(up._0.props.height, hover._0.props.height, down._0.props.height), { ctor: 'Custom',
			type: 'CustomButton',
	...
	function cssDimensions(dimensions) {
		return dimensions.top + 'px ' + dimensions.right + 'px ' + dimensions.bottom + 'px ' + dimensions.left + 'px';
	}
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Json", function(exports, require, module) {
'use strict';
...
Elm.Native.Json.make = function (localRuntime) {
	...
	function crash(expected, actual) {
		throw new Error('expecting ' + expected + ' but got ' + JSON.stringify(actual));
	}
	...
	function decodeKeyValuePairs(decoder) {
		return function (value) {
			var isObject = (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' && value !== null && !(value instanceof Array);
	...
	function decodeObject6(f, d1, d2, d3, d4, d5, d6) {
		return function (value) {
			return A6(f, d1(value), d2(value), d3(value), d4(value), d5(value), d6(value));
		};
	}

	function decodeObject7(f, d1, d2, d3, d4, d5, d6, d7) {
		return function (value) {
			return A7(f, d1(value), d2(value), d3(value), d4(value), d5(value), d6(value), d7(value));
		};
	}

	function decodeObject8(f, d1, d2, d3, d4, d5, d6, d7, d8) {
		return function (value) {
			return A8(f, d1(value), d2(value), d3(value), d4(value), d5(value), d6(value), d7(value), d8(value));
		};
	}
	...
	function decodeTuple5(f, d1, d2, d3, d4, d5) {
		return function (value) {
			...
			return A5(f, d1(value[0]), d2(value[1]), d3(value[2]), d4(value[3]), d5(value[4]));
		};
	}
	...
	function decodeTuple6(f, d1, d2, d3, d4, d5, d6) {
		return function (value) {
			...
			return A6(f, d1(value[0]), d2(value[1]), d3(value[2]), d4(value[3]), d5(value[4]), d6(value[5]));
		};
	}
	...
	function decodeTuple7(f, d1, d2, d3, d4, d5, d6, d7) {
		return function (value) {
			...
			return A7(f, d1(value[0]), d2(value[1]), d3(value[2]), d4(value[3]), d5(value[4]), d6(value[5]), d7(value[6]));
		};
	}
	...
	function decodeTuple8(f, d1, d2, d3, d4, d5, d6, d7, d8) {
		return function (value) {
			...
			return A8(f, d1(value[0]), d2(value[1]), d3(value[2]), d4(value[3]), d5(value[4]), d6(value[5]), d7(value[6]), d8(value[7]));
		};
	}
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Keyboard", function(exports, require, module) {
'use strict';
...
Elm.Native.Keyboard.make = function (localRuntime) {
	...
	var blurs = keyStream(window, 'blur', function () {
		return null;
	});
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/List", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Mouse", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Port", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Regex", function(exports, require, module) {
'use strict';
	...
	function find(n, re, str) {
		...
		while (number++ < n && (result = re.exec(string))) {
			...
			while (i > 0) {
				...
				subs[--i] = submatch === undefined ? Maybe.Nothing : Maybe.Just(submatch);
			}
			out.push({
				match: result[0],
	...
	function replace(n, re, replacer, string) {
		...
		function jsReplacer(match) {
			...
			while (i > 0) {
				...
				submatches[--i] = submatch === undefined ? Maybe.Nothing : Maybe.Just(submatch);
			}
			return replacer({
				match: match,
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Runtime", function(exports, require, module) {
'use strict';

if (!Elm.fullscreen) {
	var F2 = function F2(fun) {
		function wrapper(a) {
			return function (b) {
				return fun(a, b);
			};
    ...
    */
		...
		function initGraphics(elm, Module) {
			...
			var _requestAnimationFrame = typeof requestAnimationFrame !== 'undefined' ? requestAnimationFrame : function (cb) {
...
;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Signal", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/String", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Task", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Text", function(exports, require, module) {
'use strict';
...
Elm.Native.Text.make = function (localRuntime) {
	...
	var metaKeys = ['font-size', 'font-family', 'font-style', 'font-weight', 'href', 'text-decoration', 'color'];
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Time", function(exports, require, module) {
'use strict';
...
Elm.Native.Time.make = function (localRuntime) {
	...
	function fpsWhen(desiredFPS, isOn) {
		...
		return A2(NS.map, function (state) {
			return state.delta;
		}, A3(NS.foldp, F2(update), update(input.value, initialState), input));
	}
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Touch", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Transform2D", function(exports, require, module) {
'use strict';
...
Elm.Native.Transform2D.make = function (localRuntime) {
	...
	function rotate(t, m) {
		...
		var m11 = m[0],
		    ...
		    m21 = m[3],
		    m22 = m[4];
		return new A([m11 * c + m12 * s, -m11 * s + m12 * c, m[2], m21 * c + m22 * s, -m21 * s + m22 * c, m[5]]);
	}
	/*
 function move(xy,m) {
 	var x = xy._0;
 ...
 */
	function multiply(m, n) {
		...
		var n11 = n[0],
		    ...
		    ndx = n[2],
		    ndy = n[5];
		return new A([m11 * n11 + m12 * n21, m11 * n12 + m12 * n22, m11 * ndx + m12 * ndy + mdx, m21 * n11 + m22 * n21, m21 * n12 + m22 * n22, m21 * ndx + m22 * ndy + mdy]);
	}
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Utils", function(exports, require, module) {
'use strict';
...
Elm.Native.Utils.make = function (localRuntime) {
	...
	function badPort(expected, received) {
		throw new Error('Runtime error when sending values through a port.\n\n' + 'Expecting ' + expected + ' but was given ' + formatValue(received));
	}
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Native/Window", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Random", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Regex", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Result", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Set", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Signal", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/String", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Task", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Text", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Time", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Touch", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Trampoline", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Transform2D", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/src/Window", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/Array", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/Basics", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/Bitwise", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/Char", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/CodeGen", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/Dict", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/Equality", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/Json", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/List", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/Regex", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/Result", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/Set", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/String", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/Test/Trampoline", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/3.0.0/tests/elm-io-ports", function(exports, require, module) {
'use strict';
...
(function () {
	...
	var just = function just(v) {
		return { 'Just': v };
	};
	var handle = function handle(request) {
		switch (request.ctor) {
			case 'Put':
	...
	var handler = function handler(reqs) {
...
require.register("web/elm/elm-stuff/packages/evancz/elm-effects/2.0.1/src/Effects", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/elm-effects/2.0.1/src/Native/Effects", function(exports, require, module) {
'use strict';
...
Elm.Native.Effects.make = function (localRuntime) {
	...
	function sendCallback(time) {
		switch (state) {
			case NO_REQUEST:
				...
				// request, yet somehow we are actively fulfilling a
				// request?
				throw new Error('Unexpected send callback.\n' + 'Please report this to <https://github.com/evancz/elm-effects/issues>.');
	...
	function send(time) {
		for (var i = messageArray.length; i--;) {
			var messages = A3(List.foldl, F2(function (toAction, list) {
				return List.Cons(toAction(time), list);
			}), List.Nil, messageArray[i].tickMessages);
			Task.perform(A2(Signal.send, messageArray[i].address, messages));
		}
		messageArray = [];
	}
...
require.register("web/elm/elm-stuff/packages/evancz/elm-html/4.0.2/examples/TextReverser", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/elm-html/4.0.2/examples/Yogi", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/elm-html/4.0.2/src/Html", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/elm-html/4.0.2/src/Html/Attributes", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/elm-html/4.0.2/src/Html/Events", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/elm-html/4.0.2/src/Html/Lazy", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/start-app/2.0.2/src/StartApp", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/start-app/2.0.2/src/StartApp/Simple", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/virtual-dom/2.1.0/src/Native/VirtualDom", function(exports, require, module) {
"use strict";
    ...
    function s(o, u) {
        ...
        Elm.Native.VirtualDom.make = function (elm) {
            ...
            function makeNode(name, propertyList, contents) {
                ...
                // ensure that setting text of an input does not move the cursor
                var useSoftSet = (name === 'input' || name === 'textarea') && props.value !== undefined && !isHook(props.value);
...
require.register("web/elm/elm-stuff/packages/evancz/virtual-dom/2.1.0/src/VirtualDom", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/virtual-dom/2.1.0/src/wrapper", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/evancz/virtual-dom/2.1.0/tests/Native/TestHelpers", function(exports, require, module) {
"use strict";
...
require.register("web/elm/elm-stuff/packages/evancz/virtual-dom/2.1.0/tests/TestCases/Lazy", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/virtual-dom/2.1.0/tests/TestHelpers", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/virtual-dom/2.1.0/tests/TestMain", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/virtual-dom/2.1.0/tests/elm-io-ports", function(exports, require, module) {
'use strict';
...
var elmApp = Elm.embed(Elm.GameBoard, elmDiv, initialState);
