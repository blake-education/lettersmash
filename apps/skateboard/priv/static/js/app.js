...
Elm.Letter.make = function (_elm) {
   ...
   var BoardState = F3(function (a,b,c) {    return {board: a,players: b,wordlist: c};});
   ...
   var letterView = F2(function (address,letter) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class(letterClass(letter)),letterStyle(letter),A2($Html$Events.onClick,address,Select(letter))]),
      _U.list([$Html.text(letter.letter)]));
   });
   return _elm.Letter.values = {_op: _op
                               ,colors: colors
                               ,NoOp: NoOp
                               ,Select: Select
                               ,Submit: Submit
...
Elm.GameBoard.make = function (_elm) {
   ...
   "Letter.BoardState",
   function (v) {
      return typeof v === "object" && "board" in v && "players" in v && "wordlist" in v ? {_: {}
                                                                                          ...
                                                                                          v.wordlist)} : _U.badPort("an object with fields `board`, `players`, `wordlist`",
      v);
   });
   var incomingActions = A2($Signal.map,$Letter.UpdateBoard,boardState);
   var submitMailbox = $Signal.mailbox(_U.list([]));
   var sendSubmit = function (letters) {
      return A2($Effects.map,$Basics.always($Letter.NoOp),$Effects.task(A2($Signal.send,submitMailbox.address,letters)));
   };
   ...
   var boardRow = F2(function (address,letters) {    return A2($Html.div,_U.list([]),A2($List.map,$Letter.letterView(address),letters));});
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              ...
              ,A2($Html.div,_U.list([$Html$Attributes.$class("col-md-2")]),A2($List.map,playerView,model.boardState.players))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("col-md-2")]),A2($List.map,wordlistView,model.boardState.wordlist))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("col-md-12")]),
              _U.list([A2($Html.button,
                      _U.list([$Html$Attributes.disabled(hideClear(model.candidate)),A2($Html$Events.onClick,address,$Letter.Clear)]),
                      _U.list([$Html.text("Clear")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.disabled(hideSubmit(model.candidate)),A2($Html$Events.onClick,address,$Letter.Submit)]),
   ...
   var initialModel = {candidate: _U.list([]),boardState: {board: _U.list([]),players: _U.list([]),wordlist: _U.list([])}};
