...
Elm.Letter = Elm.Letter || {};
Elm.Letter.make = function (_elm) {
   "use strict";
   _elm.Letter = _elm.Letter || {};
   if (_elm.Letter.values) return _elm.Letter.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var letterSurrounded = function (letter) {    return _U.eq(letter.owner,0) ? false : true;};
   var Letter = F3(function (a,b,c) {    return {letter: a,id: b,owner: c};});
   var colors = _U.list(["LightGrey","Coral","CornflowerBlue","SeaGreen","MediumRedViolet","LimeGreen","Gold","Peru","DarkOrange"]);
   ...
   return _elm.Letter.values = {_op: _op,colors: colors,Letter: Letter,letterSurrounded: letterSurrounded,letterStyle: letterStyle,letterColour: letterColour};
};
...
Elm.GameBoard.make = function (_elm) {
   ...
   function (v) {
      return typeof v === "object" && "board" in v && "players" in v ? {_: {}
                                                                       ,board: typeof v.board === "object" && v.board instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.board.map(function (v) {
                                                                          return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
                                                                             return typeof v === "object" && "letter" in v && "id" in v && "owner" in v ? {_: {}
                                                                                                                                                          ...
                                                                                                                                                          v.owner)} : _U.badPort("an object with fields `letter`, `id`, `owner`",
                                                                             v);
                                                                       ...
                                                                       v.players)} : _U.badPort("an object with fields `board`, `players`",v);
   });
   var submitMailbox = $Signal.mailbox(_U.list([]));
   var submit = Elm.Native.Port.make(_elm).outboundSignal("submit",
   function (v) {
      return Elm.Native.List.make(_elm).toArray(v).map(function (v) {    return {letter: v.letter,id: v.id,owner: v.owner};});
   },
   submitMailbox.signal);
   var playerView = function (player) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text(A2($Basics._op["++"],player.name,A2($Basics._op["++"]," ",$Basics.toString(player.score))))]))]));
   };
   ...
   var initialModel = {candidate: _U.list([]),boardState: {board: _U.list([]),players: _U.list([])}};
   var init = {ctor: "_Tuple2",_0: initialModel,_1: $Effects.none};
   var UpdateBoard = function (a) {    return {ctor: "UpdateBoard",_0: a};};
   var incomingActions = A2($Signal.map,UpdateBoard,boardState);
   ...
   var letterView = F2(function (address,letter) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("letter"),$Letter.letterStyle(letter),A2($Html$Events.onClick,address,Select(letter))]),
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("jumbotron")]),_U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text("LettersMash")]))]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("board col-md-8")]),A2($List.map,boardRow(address),model.boardState.board))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("col-md-4")]),A2($List.map,playerView,model.boardState.players))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("col-md-12")]),
              _U.list([A2($Html.button,
                      _U.list([$Html$Attributes.disabled(hideClear(model.candidate)),A2($Html$Events.onClick,address,Clear)]),
                      _U.list([$Html.text("Clear")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.disabled(hideSubmit(model.candidate)),A2($Html$Events.onClick,address,Submit)]),
   ...
   var NoOp = {ctor: "NoOp"};
   var sendSubmit = function (letters) {    return A2($Effects.map,$Basics.always(NoOp),$Effects.task(A2($Signal.send,submitMailbox.address,letters)));};
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Submit": return {ctor: "_Tuple2",_0: model,_1: sendSubmit(model.candidate)};
         case "Select": return {ctor: "_Tuple2",_0: _U.update(model,{candidate: A2(appendLetter,_p0._0,model.candidate)}),_1: $Effects.none};
         case "Clear": return {ctor: "_Tuple2",_0: _U.update(model,{candidate: _U.list([])}),_1: $Effects.none};
         case "UpdateBoard": return {ctor: "_Tuple2",_0: _U.update(model,{boardState: _p0._0}),_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var Model = F2(function (a,b) {    return {candidate: a,boardState: b};});
   var BoardState = F2(function (a,b) {    return {board: a,players: b};});
...
;require.register("web/elm/Letter", function(exports, require, module) {
...
var initialState = {
  boardState: {
    board: [[{ letter: "M", id: 0, owner: 1 }, { letter: "U", id: 1, owner: 6 }, { letter: "S", id: 2, owner: 6 }, { letter: "Z", id: 3, owner: 5 }, { letter: "L", id: 4, owner: 1 }], [{ letter: "L", id: 5, owner: 1 }, { letter: "B", id: 6, owner: 1 }, { letter: "P", id: 7, owner: 1 }, { letter: "I", id: 8, owner: 5 }, { letter: "U", id: 9, owner: 5 }], [{ letter: "T", id: 10, owner: 1 }, { letter: "T", id: 11, owner: 1 }, { letter: "D", id: 12, owner: 4 }, { letter: "F", id: 13, owner: 4 }, { letter: "O", id: 14, owner: 0 }], [{ letter: "C", id: 15, owner: 0 }, { letter: "D", id: 16, owner: 2 }, { letter: "D", id: 17, owner: 2 }, { letter: "G", id: 18, owner: 4 }, { letter: "U", id: 19, owner: 2 }], [{ letter: "X", id: 20, owner: 3 }, { letter: "D", id: 21, owner: 3 }, { letter: "U", id: 22, owner: 3 }, { letter: "E", id: 23, owner: 2 }, { letter: "R", id: 24, owner: 2 }]],
...
elmApp.ports.submit.subscribe(function (letters) {
  var str = letters.reduce(function (acc, letter, index, letters) {
